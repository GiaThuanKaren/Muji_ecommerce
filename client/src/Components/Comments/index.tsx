            ...
            <div className='w-full h-fit'>
                <div className='flex items-center'>
                    ...
                    <div className="my-1 flex items-center space-x-1">
                        ...
                        <svg
                            className="w-4 h-4 text-yellow-400 dark:text-gray-500"
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
                            viewBox="0 0 22 20"
                ...
                <div className='flex items-center my-3'>
                    <div className='flex items-center'>
                        <ICON className='mr-3' icon={IconSolid.faThumbsUp} />
                        <h3>
                            Hữu ích
                        </h3>
                    </div>
                    <div className='flex items-center mx-5'>
                        <ICON className='mr-3' icon={IconSolid.faTriangleExclamation} />
                        <h3>
                            Báo Cáo Sai Phạm
                        </h3>
                    </div>
...
export default CommentCompononent